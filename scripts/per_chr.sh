...
OUTPUT_DIR=/n/users/sgibson/1000g_methylation/1000g_modkit/modkit_v0.1.11/chr15_PWS/
...
files=$(find "$OUTPUT_DIR" -type f -name "*chr15perIsland.tsv")

cat $files > merged_chr15.bed
